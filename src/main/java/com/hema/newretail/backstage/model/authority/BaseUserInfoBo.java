...
public class BaseUserInfoBo {
    ...
    public BaseCompanyData getBaseCompanyEntry() {
        return baseCompanyEntry;
    }

    public void setBaseCompanyEntry(BaseCompanyData baseCompanyEntry) {
        this.baseCompanyEntry = baseCompanyEntry;
    }
